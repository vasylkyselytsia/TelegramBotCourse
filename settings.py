...
HTML_INFO = '''
            <strong>Інформація, по використанню!</strong>
            <code>
                Для коректного пошуку потрібно вводити повідомлення у форматі:
                Тип місця  "[Назва місця]" [У радіусі (радіус пошуку)]
                [Зображення] [Записи]
            </code>
            <i> радіус пошуку </i><pre> Число метрів або кілометрів (у радіусі 50 км)</pre>
            <i> радіус пошуку </i><pre> Число метрів або кілометрів (у радіусі 50 км)</pre>
            '''
